...
const oAuth = {
  ...
  requestUserAuthorization: function requestUserAuthorization(req, res, next) {
    ...
    const url = 'https://zoom.us/oauth/authorize?response_type=code&client_id=kCrwUjv6RK5bFZ4wY7cg&redirect_uri=http%3A%2F%2Flocalhost%3A8080';
  ...
  requestAccessToken: function requestAccessToken(req, res, next) {
    ...
    const appAuthorizationString = 'a0Nyd1VqdjZSSzViRlo0d1k3Y2c6Wmt3U0F2R05Wclhoa2JVcDVmUEpobnhxY1k5a3l1M0M=';
